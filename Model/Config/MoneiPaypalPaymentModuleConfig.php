 ...
 */
class MoneiPaypalPaymentModuleConfig implements MoneiPaypalPaymentModuleConfigInterface
{
    /**
    ...
    /**
     * Constructor for MoneiPaypalPaymentModuleConfig.
     *
    ...
    /**
     * Check if the Monei PayPal payment method is enabled.
     *
    ...
    /**
     * Get the title of the Monei PayPal payment method.
     *
     * @param int|null $storeId The store ID to check the configuration for
     *
    ...
    /**
     * Get the sort order for the Monei PayPal payment method.
     *
     * @param int|null $storeId The store ID to check the configuration for
     *
    ...
    /**
     * Get the JSON style configuration for the Monei PayPal payment method.
     *
     * @param int|null $storeId The store ID to check the configuration for
     *
